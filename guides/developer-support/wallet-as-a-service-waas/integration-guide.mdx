...
description: "Install and integrate the Blockscout global wallet SDK into your dapp with npm, connect to Rootstock or other supported chains, and enable WaaS features."
icon: "page-caret-up"
---

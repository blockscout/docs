---
title: "Base API"
description: "Free Base L2 block explorer API from Blockscout with REST, JSON RPC, and ETH RPC endpoints. No paywall on core methods, multichain-ready PRO API."
---

...
<Note>
  Coming from another explorer environment? Checkout our Migration Guide to learn how you can start using Blockscout as a user or developer.
</Note>

### Learn about the Blockscout project, search features, supported chains and more.

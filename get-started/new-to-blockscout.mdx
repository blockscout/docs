...
<Note>
  Coming from another explorer environment? Welcome and check out our [Migration Guide](/get-started/migration-guide) to learn how you can start using Blockscout as a power user or power developer\!
</Note>

### General Info

- **About Blockscout**: Learn about [key features and functionality](/about/features), [history](https://www.blog.blockscout.com/blockscout-news-january-2025/), [funding](/about/funding), and the upcoming [roadmap](/about/roadmap). Our latest newsletter, article explainers, and partnership announcements are all located on the [Blockscout blog](https://www.blog.blockscout.com/).

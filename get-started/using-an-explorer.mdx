...
description: "Use the Blockscout explorer to search blocks, transactions, addresses, and verified contracts, plus set up My Account and access API endpoints."
icon: "searchengin"

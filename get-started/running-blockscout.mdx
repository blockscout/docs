...
description: "Run your own Blockscout explorer using Autoscout, Docker, Kubernetes, or manual deployment. Hosted EaaS options and ENV configuration guides included."
icon: "person-running"
...
Blockscout open-source software can be forked and used by any project to quickly setup a full-featured explorer environment. Be sure to [check the requirements](/setup/requirements) and tune your environment before deploying an explorer.

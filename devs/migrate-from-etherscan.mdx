---
title: "Migrate from Etherscan to Blockscout PRO API"
description: "Move Etherscan API calls to the Blockscout PRO API with matching endpoints, more chains, higher rate limits, and lower pricing in minutes."
...
<Accordion title="Endpoint differences between Blockscout & Etherscan">
  ...
  ### **1. Account/Address Endpoints1. Account/Address Endpoints**
  ...
  **api.blockscout.com/\{chain_id\}\{chain_id\}/json-rpc**

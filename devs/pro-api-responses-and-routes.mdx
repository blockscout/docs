---
title: "PRO API authorization, response headers, and routes"
description: "Reference for Blockscout PRO API authorization, response headers, route list, pagination, and credit costs for REST and RPC endpoints."
icon: "circle-nodes"
---

...
description: "Use Blockscout MCP prompts to locate Arbitrum and Optimism rollup deployment variables like L1 rollup init block and historical block range."
---

Unique variables are required for deploying different types of chains. The process for locating these ENVs for Arbitrum and Optimism chains is [detailed in this post](/setup/deployment/rollup-deployment). 

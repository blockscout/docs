...
Access onchain data across all Blockscout-supported chains through a single API key. Add a new chain by changing a chain ID — no new vendor setup, no duplicated integration work.

### Etherscan-Compatible Endpoints

Already using Etherscan-style API calls? Migration takes minutes. In most cases, you update the base URL and you're done. Same modules, same parameters, same response format.

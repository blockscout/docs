---
title: "PRO API general info, pricing, and routes"
description: "Overview of the Blockscout PRO API: pricing tiers, authorization, available REST and RPC routes, pagination rules, and credit cost tables."
icon: "circle-nodes"
---

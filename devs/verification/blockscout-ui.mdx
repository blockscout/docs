---
title: "Verify contracts using the Blockscout UI"
description: "Verify Solidity and Vyper smart contracts directly from the Blockscout UI using seven input methods including flattened source, JSON, and Sourcify."
---

---
title: "Verify contracts via Sourcify on Blockscout"
description: "Verify smart contracts on Blockscout using the Sourcify verification option, matching metadata and source files against Sourcify's decentralized repo."
---

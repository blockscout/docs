...
description: "Verify Arbitrum Stylus smart contracts located in public GitHub repositories using the Blockscout verification API and Stylus verifier endpoint."
---
...
## **How to verify your Stylus contracts using the Blockscout’s API**

---
title: "Smart contract verification websocket events"
description: "Subscribe to Blockscout websocket notifications for smart contract verification results and automated source lookup lifecycle events on V2 and legacy sockets."
---

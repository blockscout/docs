...
description: "Read from and write to verified smart contracts directly in the Blockscout UI by connecting a web3 wallet like MetaMask to any supported chain."
---

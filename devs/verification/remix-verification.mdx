---
title: "Verify contracts with the Remix IDE plugin"
description: "Verify smart contracts on Blockscout directly from Remix IDE using the built-in contract verification plugin available since Remix v0.56.0."
---

---
title: "Verify contracts with the Hardhat plugin"
description: "Verify smart contracts on Blockscout from your Hardhat project using the hardhat-verify plugin with the per-instance API and no key required."

...
Singular Blockscout instances don't currenlty require a key. However, if you are using the recommended Pro API setup, add your key under `verify.blockscout`:

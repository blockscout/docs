...
<Check>
  Our Universal PRO API is available for beta access, please go to https://dev.blockscout.com/ to get an API key and get started. You can then use the PRO API endpoint to access REST and RPC methods.
</Check>
...
- You can add the PRO API key at https://dev.blockscout.com/). My Account API keys will be deprecated shortly. For now, check [My Account and adding API Keys](/using-blockscout/my-account/api-keys) for individual instance keys.
- More info on [API Requests and Limits](/devs/apis/requests-and-limits)
- PRO API keys are available at https://dev.blockscout.com/

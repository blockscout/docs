...
**Plan credit allowances for reference:**

| Plan                | Monthly Credits | Overage Rate |
| ------------------- | :-------------: | :----------: |
| Free                | 100,000/day     | —            |
| Builder (\$49/mo)   | 100M            | \$0.50/1M    |
| Pro (\$199/mo)      | 500M            | \$0.40/1M    |
| Business (\$999/mo) | 3,000M          | \$0.32/1M    |

[_Source: endpoint-pricing-config.json · February 2026_](https://github.com/blockscout/backend-configs/blob/23ce1258a499a76bd18ce649ff1a07c6ae800042/pro-api/prod/endpoint-pricing-config.json)
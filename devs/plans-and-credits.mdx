...
## Blockscout Pro API — Credit Usage per Endpoint

Credits are consumed per API call. A **default call is 20 credits** for any endpoint not listed below. Updated February, 2026

...
Blockscout uses a credit system to weight different calls based on size and usage. This creates additional efficiency and saves resources depending on the types of call you need to make. See the [blockscout credit costs table](#blockscout-credit-costs) for more info on individual calls.

---
title: "Show wallet history with the Blockscout REST API"
description: "Fetch balances, transactions, token transfers, and NFT activity for a wallet or portfolio tracker using Blockscout REST API and PRO endpoints."
icon: "wallet"
---

...
Websockets allow you to monitor ongoing events on the blockchain. A single connection can hold up to 100 subscriotions across blocks, addresses, tokens and more.

---
title: "WebSocket API"
description: "Subscribe to real-time blockchain events like new blocks, transactions, and logs across multiple chains over a single multiplexed WebSocket connection."
icon: "wrench"
---
...
| `already_subscribed` | Already subscribed to this topic and chain combination |

---
title: "WebSocket API"
description: "Subscribe to real-time blockchain events like new blocks, transactions, and balance changes across multiple chains over a single multiplexed WebSocket connection."
icon: "wrench"
---

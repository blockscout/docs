---
title: "Stats module RPC endpoints"
description: "Reference for the Blockscout stats RPC module with endpoints for token supply, native coin supply, market cap, and chain-level statistics."
---

---
title: "Logs module RPC endpoints"
description: "Reference for the Blockscout logs RPC module and its getLogs endpoint for querying event logs by address, block range, and topic filters."
---

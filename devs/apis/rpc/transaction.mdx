---
title: "Transaction module RPC endpoints"
description: "Reference for the Blockscout transaction RPC module with endpoints for transaction info, receipt status, logs, and confirmations by hash."
---

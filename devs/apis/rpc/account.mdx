---
title: "Account module RPC endpoints"
description: "Reference for the Blockscout account RPC module, including endpoints for address balances, transactions, token transfers, and mined blocks."
---

---
title: "Block module RPC endpoints"
description: "Reference for the Blockscout block RPC module, covering endpoints for block rewards, uncle rewards, and block lookups by number or timestamp."
---
...
Returns the estimated time remaining, in seconds, until a certain block is included in the blockchain.

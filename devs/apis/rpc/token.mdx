---
title: "Token module RPC endpoints"
description: "Reference for the Blockscout token RPC module, including endpoints returning ERC-20 and ERC-721 name, symbol, supply, and holder data."
---

...
description: "How the Blockscout PRO API returns proxied responses and structured error objects with error and source fields for internal vs upstream failures."
icon: "blueberries"
---

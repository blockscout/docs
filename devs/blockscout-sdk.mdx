...
description: "React SDK for integrating Blockscout transaction notifications and history into dApps with real-time updates and mobile-responsive design."
icon: "cube"
---
...
<Check>
* Repo: https://github.com/blockscout/app-sdk

...
Etherscan uses a subdomain link for api access. For example, for the Ethereum explorer the api link is [https://api.etherscan.io/](https://api.etherscan.io/) followed by your query, or for Optimism it is [https://api-optimistic.etherscan.io/api](../using-blockscout/my-account/) followed by your query. To replace, simply use the regular blockscout url for the instance, for example [https://eth.blockscout.com/](https://eth.blockscout.com/) for Ethereum or [https://optimism.blockscout.com/](https://optimism.blockscout.com/) for Optimism.

Standard API routes used with Etherscan work for your queries on Blockscout. We've structured our data calls to be consistent with Etherscan whenever possible. You can see supported calls in the [JSON RPC & ETH Compatible RPC endpoints section](apis/rpc/).
...
4. Find the block explorer url (in this case the default setting is [https://optimistic.etherscan.io/](https://optimistic.etherscan.io/)).
5. Change the url to blockscout (in this case [https://optimism.blockscout.com/](https://optimism.blockscout.com/)) and Save.

---
title: "Build a crypto tax calculator with PRO API"
description: "Fetch full wallet history including transactions, internal txs, and token transfers across chains with the Blockscout PRO API for tax reporting."
icon: "calculator"
---

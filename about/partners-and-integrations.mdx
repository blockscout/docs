...
| <img src="/images/ba2cbbd0-image.jpeg" className='w-36'/> | [**Truffle**](https://trufflesuite.com/) provides a comprehensive suite of tools for smart contract development. Contracts can be verified using truffle-plugin-verify. [Learn more](/devs/verification/openzeppelin-contract-verification#truffle).                                             |
| <img src="/images/c413c328-image.jpeg" className='w-36'/> | [**Foundry**](https://github.com/foundry-rs/foundry/) is a smart contract development toolchain and Forge is a command-line tool that ships with Foundry that supports contract verification with Blockscout. [Learn More](/devs/verification/openzeppelin-contract-verification#foundry-forge). |
| <img src="/images/ee9549d3-image.jpeg" className='w-36'/> | [**Remix**](https://remix-project.org/)is a simple no-setup tool with a GUI for developing smart contracts. The Flattener plugin can be used to verify contracts in Blockscout. [Learn More](/devs/verification/openzeppelin-contract-verification#remix).                                      |

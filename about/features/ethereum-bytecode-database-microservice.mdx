...
description: "The Ethereum Bytecode Database (EBD) microservice shares verified smart contract source code across chains by mapping bytecodes to sources."
icon: "database"
---
...
To address this issue, we have implemented a database for verified contract information which can be shared across all supported chains. This database and its associated functionality have been created as a Blockscout microservice called the **Ethereum Bytecode Database (Blockscout EBD).**

...
description: "Verify Solidity and Vyper smart contracts programmatically using the Vera proxy-verifier API with standard JSON input or multi-part endpoints."
icon: "terminal"
---

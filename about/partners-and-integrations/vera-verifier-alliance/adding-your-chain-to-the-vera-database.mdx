...
description: "Configure eth-bytecode-db, CHAIN_ID, and API keys to add your Blockscout instance to the Verifier Alliance shared contract verification database."
icon: "plus-circle"
---

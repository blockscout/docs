...
A `429 Too Many Requests` means you've exceeded your plan's RPS. You can eitheradd a short delay between requests or move up a tier. A `401 Unauthorized` usually means the key isn't being sent correctly; double-check it against the dashboard.

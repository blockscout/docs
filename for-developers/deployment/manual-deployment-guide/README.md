...
* You can check, that service works by requesting [http://localhost:8083/health](http://localhost:8083/health). It should return `` Query deserialize error: missing field `service` ``
...
* Check that the sc-verifier service works by requesting [http://localhost:8082/api/v2/verifier/solidity/versions](http://localhost:8082/api/v2/verifier/solidity/versions) page - it should return the list of compilers:

...
<AccordionGroup>
  ...
  <Accordion title="How do I speed up my self-hosted instance?">
    ...
    - increase the memory limit for indexers using the [INDEXER_MEMORY_LIMIT](https://docs.blockscout.com/setup/env-variables/backend-env-variables#indexer-management:~:text=INDEXER%5FMEMORY%5FLIMIT) ENV if indexing is slow.

...
description: "Tune Blockscout indexer fetcher batch size and concurrency to resolve JSON-RPC timeout errors and reduce load on the underlying archive node."
---

---
title: "Fix indexer memory errors by adjusting memory usage"
description: "Configure INDEXER_MEMORY_LIMIT and understand how the Blockscout indexer memory monitor shrinks work queues to prevent BEAM memory errors."
---

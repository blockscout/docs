---
title: "Blockscout architecture overview"
sidebarTitle: "Overview"
description: "Explore Blockscout architecture and organization including indexer, web app, API modes, umbrella project layout, ShareLock, and EVM versions."
icon: "info-circle"
---

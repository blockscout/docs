...
description: "Overview of Blockscout indexer architecture: realtime and catchup indexers, secondary and on-demand fetchers, and chain-specific integrations."
---

---
title: "Blockscout Indexer Memory Usage and Limits"
description: "Control Blockscout indexer memory with INDEXER_MEMORY_LIMIT, understand soft-limit behavior, queue shedding, and Ethereum mainnet requirements."
---

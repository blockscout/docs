---
title: "Blockscout Logger Configs and Log Rotation"
description: "Tune Blockscout log level, rotation, max file size, and file count per umbrella app to control disk usage in indexer, explorer, and web logs."
---

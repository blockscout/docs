---
title: "Application Tracing with Spandex and Datadog"
description: "Enable Blockscout application tracing via Spandex with Datadog as a backend, configure per-app tracers, and swap in alternative tracing backends."
---

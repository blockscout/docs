---
title: "reCAPTCHA Setup for Blockscout CSV and Account"
description: "Enable Google reCAPTCHA v2 invisible on Blockscout to block bots on CSV exports and account features using site key and secret key ENV variables."
---

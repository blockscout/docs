---
title: "Automating Blockscout Restarts with HEART_COMMAND"
description: "Configure Blockscout to auto-restart on crash using the HEART_COMMAND env variable, heart beat timeouts, and Erlang crash dump settings."
---

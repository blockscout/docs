---
title: "Prometheus and Grafana Metrics for Blockscout"
description: "Export Blockscout metrics on /metrics for Prometheus and visualize node and web performance in Grafana dashboards using BEAM dashboards."
---

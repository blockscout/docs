---
title: "Deploy Blockscout on Rollup Chains"
description: "Deploy Blockscout as an L2 rollup explorer with environment variables and settings for Optimism, Arbitrum, zkSync, and other supported rollup stacks."
icon: "layer-group"
---
...
<Info>
  Arbitrum environment variables are located here: https://docs.blockscout.com/setup/env-variables/backend-envs-chain-specific#arbitrum-management
</Info>
...
Set to the settlement layer RPC node. In the case above (Ethereum settlement layer) it would be set to your choice of Ethereum RPC nodes such as https://rpc.ankr.com/eth or another one of your choice [from this list](https://www.alchemy.com/chain-connect/chain/ethereum). If the rollup settles to a testnet, for example Arbitrum Sepolia, it would be set to https://arbitrum-sepolia.blockscout.com/ ( [info retrieved here](https://docs.arbitrum.io/build-decentralized-apps/reference/node-providers))
...
<Frame caption>
  ![](/images/3cb03a01-image.jpeg)
</Frame>

<Frame caption>
  ![](/images/c2970836-image.jpeg)
</Frame>
...
<Info>
  Optimism environment variables are located here: https://docs.blockscout.com/setup/env-variables/backend-envs-chain-specific#optimism-rollup-management
</Info>

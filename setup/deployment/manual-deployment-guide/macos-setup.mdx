---
title: "Manual Blockscout Setup on macOS"
description: "Install and run Blockscout backend, frontend, and PostgreSQL on macOS using Homebrew, with step-by-step instructions for a working local explorer."
---

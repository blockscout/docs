---
title: "Manual Blockscout Setup on Ubuntu"
description: "Install and run Blockscout backend, frontend, and PostgreSQL on Ubuntu with apt packages, Erlang, Elixir, and Node.js configuration steps."
---

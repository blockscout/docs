---
title: "Upgrade Guide for Blockscout v7.0 and v8.0"
description: "Step-by-step upgrade instructions for moving existing Blockscout deployments to major versions 7.0 and 8.0, including database migrations and env changes."
icon: "arrow-up"
---

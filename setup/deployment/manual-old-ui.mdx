---
title: "Manual Deployment: Backend and Legacy UI"
description: "Deploy the Blockscout backend with the deprecated legacy UI on hardware or cloud infrastructure. Use the newer Manual Deployment Guide when possible."

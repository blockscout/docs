---
title: "Docker Compose Deployment for Blockscout"
description: "Run a full Blockscout explorer locally with Docker Compose, including backend, frontend, database, and microservices for development and testing."
icon: "box-open"
---

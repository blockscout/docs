---
title: "Manual Deployment Guide for Blockscout"
description: "Manually deploy Blockscout backend, new frontend, and microservices on your own hardware or cloud VM with step-by-step Ubuntu and macOS instructions."

---
title: "Deploy Blockscout for Cosmos-Based Chains"
description: "Use Blockscout as a block explorer for Cosmos-based chains through the Fair Math SHUTTLE proxy, which bridges EVM-style RPC requests over WebSocket and HTTP."
icon: "globe"
---

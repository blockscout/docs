...
description: "Deploy Blockscout explorer to a Kubernetes cluster using the official Helm charts for backend, frontend, PostgreSQL, and supporting microservices."
icon: "server"
---

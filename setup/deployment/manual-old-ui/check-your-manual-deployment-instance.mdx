---
title: "Clean a Previous Manual Blockscout Instance"
description: "Remove build artifacts, node modules, static assets, and PostgreSQL data from a previous manual Blockscout deployment before redeploying or upgrading."
---

---
title: "AWS Permissions and Settings for Blockscout Deploy"
sidebarTitle: "Overview"
description: "AWS permissions, IAM keys, and resources created for Blockscout Terraform and Ansible deployments, including VPC, ALB, ASG, and CodeDeploy setup."
---

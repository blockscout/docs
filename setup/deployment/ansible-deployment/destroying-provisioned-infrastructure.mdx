---
title: "Destroy Blockscout AWS Infrastructure"
description: "Tear down provisioned AWS resources for a Blockscout Ansible deployment using Terraform destroy commands to safely remove VPC, EC2, and RDS assets."
---

---
title: "Ansible Deployment Variables Reference"
description: "Reference for infrastructure, Blockscout, and shared YAML variables required by the Ansible playbooks to configure a Blockscout explorer per chain."
---

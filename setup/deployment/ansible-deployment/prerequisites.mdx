---
title: "Ansible Deployment Prerequisites"
description: "Required software, AWS credentials, and Terraform/Ansible dependencies to run the Blockscout deployment playbooks from a jumpbox or local machine."
---

---
title: "Updating and Redeploying Blockscout on AWS"
description: "Update or redeploy a Blockscout instance on AWS by uploading a new version, stopping the service, running manual deploy steps, and migrating the DB."
icon: "sync"
---

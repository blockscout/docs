---
title: "AWS Marketplace Prerequisites and Install Parameters"
description: "Blockscout AWS Marketplace prerequisites and install parameters: EC2 key pair, ACM certificate, archive node URL, DB password, and Cognito setup."
icon: "cogs"
---

---
title: "AWS EC2 Archive Node Setup with OpenEthereum"
description: "Provision an AWS EC2 archive node for Blockscout using OpenEthereum (formerly Parity), with example node.toml configs including xDai settings."
icon: "server"
---

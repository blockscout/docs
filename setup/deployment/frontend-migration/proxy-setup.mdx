---
title: "NGINX Proxy Setup for Frontend Migration"
description: "Configure an NGINX reverse proxy to route API, socket, and sitemap paths to the Blockscout backend while serving the new frontend from the same domain."
---
...
<Info>
***NOTE:*** For production usage you should add at a minimum the correct `server_name` (ie [eth.blockscout.com](http://eth.blockscout.com/)) and TLS info (`ssl_certificate`, `ssl_certificate_key`, `other required variables?`) at a minimum.

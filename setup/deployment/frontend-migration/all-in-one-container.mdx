---
title: "All-in-One Docker Compose Frontend Migration"
description: "Migrate to the new Blockscout frontend using the all-in-one docker-compose.yml file that runs backend, frontend, and services in a single stack."
---

---
title: "Frontend Migration with Separate Frontend"
description: "Run the Blockscout frontend as a separate service using external-frontend.yml so you can customize the UI or host it independently from the backend."
---
...
<Frame caption="">
  <img src="/images/622be7a0-image.jpeg" />
</Frame>

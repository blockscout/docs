---
title: "Frontend Migration with Customized Backend"
description: "Migrate to the new Blockscout frontend while keeping an externally hosted or customized backend using the external-backend.yml Docker Compose file."
---
...
### 3) Run docker compose with BACK\_PROXY_PASS variable.

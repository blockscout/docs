---
title: "Blockscout Environment Variables Overview"
description: "Reference for backend, frontend, and microservice environment variables used to configure a Blockscout explorer instance across chains and integrations."

---
title: "Smart contract verification microservice"
description: "Deep dive into the Blockscout Rust smart contract verifier microservice supporting Solidity, Vyper, and Sourcify verification over HTTP."
---
...
In case of an error, an enum is returned with the corresponding error and its description (e.g. if compilation failed, a Compilation error is returned with the error data obtained from the compiler).

---
title: "L2 to L1 JSON-RPC method requests"
description: "Reference of L1 JSON-RPC methods and polling patterns Blockscout fetchers use for Arbitrum, Optimism, Scroll, Shibarium, zkSync, and Polygon zkEVM."
---

---
title: "Celestia Node and Indexer for Blockscout"
description: "Run a Celestia light node and blobs indexer alongside Blockscout with Docker Compose, PostgreSQL, and env config for mocha or mainnet."
icon: "globe"
---
...
- Examples and descriptions for the API are available in the project's readme: https://github.com/blockscout/blockscout-rs/tree/main/da-indexer#readme

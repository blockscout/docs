...
| Variable                                 | Description                                                                                                                                                                                                    | Parameters                                                        |
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| `MICROSERVICE_MULTICHAIN_SEARCH_ENABLED` | If `true`, integration with [Multichain Search Service](https://github.com/blockscout/blockscout-rs/tree/main/multichain-search) is enabled. Implemented in [#11139](https://github.com/blockscout/blockscout/pull/11139) | <p>Version: master<br>Default: (empty)<br>Applications: API, Indexer</p> |
| `MICROSERVICE_MULTICHAIN_SEARCH_URL`     | Multichain Search Service API URL. Implemented in [#11139](https://github.com/blockscout/blockscout/pull/11139)                                                                                                             | <p>Version: master<br>Default: (empty)<br>Applications: API, Indexer</p> |

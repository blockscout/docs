...
<Note>
  Ads are enabled by default on all self-hosted instances. If you would to disable ads, you can disable using the [Autoscout hosted service](/using-blockscout/autoscout).
</Note>

...
- [App configuration](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#app-configuration)
- [Blockchain parameters](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#blockchain-parameters)
- [API configuration](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#api-configuration)
- [UI configuration](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#ui-configuration)
  - [Homepage](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#homepage)
  - [Navigation](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#navigation)
  - [Footer](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#footer)
  - [Favicon](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#favicon)
  - [Meta](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#meta)
  - [Views](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#views)
    - [Block](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#block-views)
    - [Address](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#address-views)
    - [Transaction](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#transaction-views)
    - [NFT](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#nft-views)
  - [Misc](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#misc)
- [App features](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#app-features)
  - [My account](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#my-account)
  - [Gas tracker](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#gas-tracker)
  - [Advanced filter](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#advanced-filter)
  - [Address verification](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#address-verification-in-my-account) in "My account"
  - [Blockchain interaction](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#blockchain-interaction-writing-to-contract-etc) (writing to contract, etc.)
  - [Banner ads](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#banner-ads)
  - [Text ads](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#text-ads)
  - [Beacon chain](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#beacon-chain)
  - [User operations](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#user-operations-erc-4337)
  - [Rollup chain](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#rollup-chain)
  - [Export data to CSV file](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#export-data-to-csv-file)
  - [Google analytics](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#google-analytics)
  - [Mixpanel analytics](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#mixpanel-analytics)
  - [GrowthBook feature flagging and A/B testing](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#growthbook-feature-flagging-and-ab-testing)
  - [GraphQL API documentation](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#graphql-api-documentation)
  - [REST API documentation](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#rest-api-documentation)
  - [Marketplace](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#marketplace)
  - [Solidity to UML diagrams](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#solidity-to-uml-diagrams)
  - [Blockchain statistics](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#blockchain-statistics)
  - [Web3 wallet integration](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#web3-wallet-integration-add-token-or-network-to-the-wallet) (add token or network to the wallet)
  - [Transaction interpretation](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#transaction-interpretation)
  - [Verified tokens info](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#verified-tokens-info)
  - [Name service integration](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#name-service-integration)
  - [Metadata service integration](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#metadata-service-integration)
  - [Public tag submission](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#public-tag-submission)
  - [Data availability](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#data-availability)
  - [Bridged tokens](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#bridged-tokens)
  - [Safe{Core} address tags](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#safecore-address-tags)
  - [Address profile API](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#address-profile-api)
  - [Address XStar XHS score](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#address-xstar-xhs-score)
  - [SUAVE chain](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#suave-chain)
  - [Celo chain](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#celo-chain)
  - [Ton Application Chain (TAC)](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#ton-application-chain-tac)
  - [MetaSuites extension](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#metasuites-extension)
  - [Validators list](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#validators-list)
  - [Sentry error monitoring](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#sentry-error-monitoring)
  - [Rollbar error monitoring](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#rollbar-error-monitoring)
  - [OpenTelemetry](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#opentelemetry)
  - [DeFi dropdown](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#defi-dropdown)
  - [Multichain balance button](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#multichain-balance-button)
  - [Get gas button](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#get-gas-button)
  - [Save on gas with GasHawk](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#save-on-gas-with-gashawk)
  - [Rewards service API](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#rewards-service-api)
  - [DEX pools](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#dex-pools)
- [3rd party services configuration](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#external-services-configuration)
...
| NEXT_PUBLIC_NETWORK_ID                      | `number`                 | Chain id, see https://chainlist.org for the reference                                                                                                      | Required       | -             | `99`                       | v1.0.x\+  |
| NEXT_PUBLIC_NETWORK_RPC_URL                 | `string | Array<string>` | Chain public RPC server url, see https://chainlist.org for the reference. Can contain a single string value, or an array of urls.                          | -              | -             | `https://core.poa.network` | v1.0.x\+  |
...
| NEXT_PUBLIC_HOMEPAGE_PLATE_TEXT_COLOR   | `string`                                                                                                                                                                                                | Text color of the hero plate on the homepage (escape "#" symbol if you use HEX color codes or use rgba-value instead). **DEPRECATED** __`Use NEXT_PUBLIC_HOMEPAGE_HERO_BANNER_CONFIG instead`__        | -              | `white`                                                                                                                                                                                                                             | `\#DCFE76`                                                                                                                                         | v1.0.x\+  |
| NEXT_PUBLIC_HOMEPAGE_PLATE_BACKGROUND   | `string`                                                                                                                                                                                                | Background css value for hero plate on the homepage (escape "#" symbol if you use HEX color codes or use rgba-value instead). **DEPRECATED** __`Use NEXT_PUBLIC_HOMEPAGE_HERO_BANNER_CONFIG instead`__ | -              | `radial-gradient(103.03% 103.03% at 0% 0%, rgba(183, 148, 244, 0.8) 0%, rgba(0, 163, 196, 0.8) 100%), var(--chakra-colors-blue-400)`                                                                                                | `radial-gradient(at 15% 86%, hsla(350,65%,70%,1) 0px, transparent 50%)` \| `no-repeat bottom 20% right 0px/100% url(https://placekitten/1400/200)` | v1.1.0\+  |
| NEXT_PUBLIC_HOMEPAGE_HERO_BANNER_CONFIG | `HeroBannerConfig`, see details [below](/setup/env-variables/frontend-common-envs/envs#hero-banner-configuration-properties)                                                                            | Configuration of hero banner appearance.                                                                                                                                                               | -              | -                                                                                                                                                                                                                                   | See [below](/setup/env-variables/frontend-common-envs/envs#hero-banner-configuration-properties)                                                   | v1.35.0\+ |
...
| NEXT_PUBLIC_FEATURED_NETWORKS             | `string`                             | URL of configuration file (`.json` format only) or file content string representation. It contains list of featured networks that will be shown in the network menu. See [below](/setup/env-variables/frontend-common-envs/envs#featured-network-configuration-properties) list of available properties for particular network | -              | -             | `https://example.com/featured_networks_config.json` \| `[{'title':'Astar(EVM)','url':'https://astar.blockscout.com/','group':'Mainnets','icon':'https://example.com/astar.svg'}]` | v1.0.x\+  |
...
| NEXT_PUBLIC_RE_CAPTCHA_APP_SITE_KEY | `boolean` | See [below](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#google-recaptcha)                                                                                                           | Required       | -             | `<your-secret>`                                | v1.0.x\+ |
...
_Note_ all ENV variables required for [My account](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#my-account) feature should be passed alongside the following ones:
...
| NEXT_PUBLIC_NETWORK_RPC_URL           | `string` | See in [Blockchain parameters](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#blockchain-parameters) section | Required       | -             | `https://core.poa.network` | v1.0.x\+ |
| NEXT_PUBLIC_NETWORK_NAME              | `string` | See in [Blockchain parameters](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#blockchain-parameters) section | Required       | -             | `Gnosis Chain`             | v1.0.x\+ |
| NEXT_PUBLIC_NETWORK_ID                | `number` | See in [Blockchain parameters](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#blockchain-parameters) section | Required       | -             | `99`                       | v1.0.x\+ |
| NEXT_PUBLIC_NETWORK_CURRENCY_NAME     | `string` | See in [Blockchain parameters](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#blockchain-parameters) section | Required       | -             | `Ether`                    | v1.0.x\+ |
| NEXT_PUBLIC_NETWORK_CURRENCY_SYMBOL   | `string` | See in [Blockchain parameters](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#blockchain-parameters) section | Required       | -             | `ETH`                      | v1.0.x\+ |
| NEXT_PUBLIC_NETWORK_CURRENCY_DECIMALS | `string` | See in [Blockchain parameters](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#blockchain-parameters) section | -              | `18`          | `6`                        | v1.0.x\+ |
...
| NEXT_PUBLIC_ROLLUP_L1_BASE_URL                 | `string`                                                                                                                 | Blockscout base URL for L1 network. **DEPRECATED** __`Use NEXT_PUBLIC_ROLLUP_PARENT_CHAIN instead`__                                                                                                                                                                                                         | Required                          | -             | `'http://eth-goerli.blockscout.com'`                           | v1.24.0\+ |
...
| NEXT_PUBLIC_ROLLUP_PARENT_CHAIN_NAME           | `string`                                                                                                                 | Set to customize L1 transaction status labels in the UI (e.g., "Sent to "). This setting is applicable only for Arbitrum-based chains. **DEPRECATED** __`Use NEXT_PUBLIC_ROLLUP_PARENT_CHAIN instead`__                                                                                                      | -                                 | -             | `DuckChain`                                                    | v1.37.0\+ |
| NEXT_PUBLIC_ROLLUP_PARENT_CHAIN                | `ParentChain`, see details [below](/setup/env-variables/frontend-common-envs/envs#parent-chain-configuration-properties) | Configuration parameters for the parent chain.                                                                                                                                                                                                                                                               | -                                 | -             | `{'baseUrl':'https://explorer.duckchain.io'}`                  | v1.38.0\+ |
...
| Variable  | Type                                                  | Description                                                                                                                                                                    | Compulsoriness | Default value | Example value                                |
| --------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------- | ------------- | -------------------------------------------- |
| id        | `number`                                              | Chain id, see https://chainlist.org for the reference.                                                                                                                         | -              | -             | `42`                                         |
...
| rpcUrls   | `Array<string>`                                       | Chain public RPC server urls, see https://chainlist.org for the reference.                                                                                                     | -              | -             | `['https://rpc.duckchain.io']`               |
...
| Variable                            | Type     | Description                                                                                                                   | Compulsoriness | Default value | Example value   | Version  |
| ----------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------- | -------------- | ------------- | --------------- | -------- |
| NEXT_PUBLIC_RE_CAPTCHA_APP_SITE_KEY | `string` | See [below](https://github.com/blockscout/docs/blob/master/setup/env-variables/frontend-common-envs/ENVS.md#google-recaptcha) | true           | -             | `<your-secret>` | v1.0.x\+ |
...
| Variable                         | Type                                                                                                           | Description                                                                                                                                              | Compulsoriness | Default value | Example value | Version   |
| -------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ------------- | ------------- | --------- |
| NEXT_PUBLIC_ADDRESS_USERNAME_TAG | `{api_url: string; tag_link_template: string; tag_icon: string; tag_bg_color: string; tag_text_color: string}` | Address profile API tag configuration properties. See [below](/setup/env-variables/frontend-common-envs/envs#user-profile-api-configuration-properties). | -              | -             | `uniswap`     | v1.35.0\+ |
...
| Variable                                       | Type                                                                       | Description                                                                                                                                    | Compulsoriness | Default value | Example value                                                                                                         | Version   |
| ---------------------------------------------- | -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ------------- | --------------------------------------------------------------------------------------------------------------------- | --------- |
| NEXT_PUBLIC_MULTICHAIN_BALANCE_PROVIDER_CONFIG | `[{ name: string; url_template: string; dapp_id?: string; logo: string }]` | Multichain portfolio application config See [below](/setup/env-variables/frontend-common-envs/envs#multichain-button-configuration-properties) | -              | -             | `[{ name: 'zerion', url_template: 'https://app.zerion.io/{address}/overview', logo: 'https://example.com/icon.svg'}]` | v1.31.0\+ |

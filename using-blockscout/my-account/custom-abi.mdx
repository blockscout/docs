---
title: "Custom ABI"
description: "Add a Custom ABI in Blockscout My Account to debug, test, and use the Write Custom feature on both verified and unverified smart contracts."
---
...
You will need to be logged into My Account to interact with your custom ABIs. Once you've added it, you can visit the contract to interact with the custom ABI.

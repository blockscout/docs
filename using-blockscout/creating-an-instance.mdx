...
description: "Step-by-step guide to configuring an Autoscout explorer instance with chain info, RPC, branding, indexer tuning, and rollup settings."
...
- **HTTP RPC URL\***: The **archive node** url ([https://your-rpc-url](https://your-rpc-url)) [**_Note: archive node is required for internal transactions and token/coin historical balances. Tracing should be enabled for internal transactions._**](/setup/requirements/node-tracing-json-rpc-requirements)

...
description: "Integrate your dapp with Dappscout using iframe support and the Safe Apps SDK to gain top listing, embed inside Blockscout, and share wallets."
---

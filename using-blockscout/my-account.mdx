---
title: "My Account"
description: "Sign in to Blockscout My Account to add watchlists, private tags, custom ABIs, verified addresses, and receive email notifications on activity."
...
- **Verified Addresses**: Verifying ownership of a smart contract address allows you to easily update information in Blockscout
...
<Check>
  _The following example is created using the [Optimism Blockscout instance](https://optimism.blockscout.com/)._
</Check>

#### 1) Click the MyAccount Icon

<Frame caption="Generic My Account icon displays when you are not signed in">
  ![](/images/1cf92ab5-image.jpeg)
</Frame>

<Frame caption="Mobile MyAccount icon">
  ![](/images/de0456e6-image.jpeg)
</Frame>
...
<Frame>
  ![](/images/30be00ac-image.jpeg)
</Frame>

#### 2a) Email and Password

Enter a valid email and password to setup an account. You will receive a validation notice to your email, be sure to check spam filters as it will come from [_noreply@blockscout.com_](mailto:noreply@blockscout.com).

<Frame caption="Enter your email and a valid password">
  ![](/images/05587181-image.jpeg)
</Frame>

<Frame caption="You will be forwarded to the verify page. Check your email to verify your new account.">
  ![](/images/e3e7749b-image.jpeg)
</Frame>

<Frame caption="Confirm your account from email. Email will come from noreply@blockscout.com">
  ![](/images/01823883-image.jpeg)
</Frame>

#### 2b) Github

<Frame caption="Authorize blockscout access using your github account">
  ![](/images/5bc5652a-image.jpeg)
</Frame>

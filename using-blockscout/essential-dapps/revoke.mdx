...
<Check>
Find Revokescout via the Dappscout marketplace.
...
Revokescout can be accessed directly via the Essential Dapps menu or as an app via the Dappscout interface in Blockscout on supported chains.

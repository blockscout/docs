---
title: "Revoke"
description: "Use the Blockscout Revoke Essential Dapp to review and revoke ERC-20 and NFT token approvals across Ethereum, OP Mainnet, Gnosis, Base, and Ink."
icon: "square-minus"
---
...
<Frame caption="Success message - takes a moment for permssion to be removed from UI">
  ![](/images/fa186fad-image.jpeg)
</Frame>

<Frame caption="Permssions updated">
  ![](/images/bc74d5d4-image.jpeg)
</Frame>

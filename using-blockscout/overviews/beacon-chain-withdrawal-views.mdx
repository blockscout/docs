---
title: "Beacon Chain Withdrawal Views in Blockscout"
description: "See how Blockscout displays Ethereum beacon chain validator withdrawals on block and address pages, including index, validator index, amount, and recipient."
---
...
The unique `index`, assigned `validatorIndex`, withdrawal receiving `address`, and `amount` are all included in the withdrawals structure are displayed on Blockscout on the block and addresses pages.
...
<Frame>
  ![](/images/12f8357f-image.jpeg)
</Frame>

### Address page example

<Frame>
  ![](/images/daaf31ba-image.jpeg)
</Frame>
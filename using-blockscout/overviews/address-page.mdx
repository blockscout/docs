---
title: "Address Page: EOA Fields, Tabs, and Metrics"
description: "Explore the Blockscout address page for EOAs: balance, tokens, transactions, ENS names, tags, watchlist, multichain data, and activity analytics."
---

---
title: "Transaction Types: Blob, Coin, Contract, and Token"
description: "How Blockscout categorizes transactions including blob (EIP-4844), coin transfer, contract call, contract creation, token transfer, minting, and burning."
---
...
<Frame caption="Transaction types in UI v2">
  ![](/images/10a1708b-image.jpeg)
</Frame>

<Frame caption="Transaction types in UI v1">
  ![](/images/11e455a3-image.jpeg)
</Frame>
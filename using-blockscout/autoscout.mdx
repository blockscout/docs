...
<Check>
  Autoscout is now available at https://deploy.blockscout.com/
</Check>
...
- **HTTP RPC URL\***: The **archive node** url (https://your-rpc-url) [**_Note: archive node is required for internal transactions and token/coin historical balances. Tracing should be enabled for internal transactions._**](/setup/requirements/node-tracing-json-rpc-requirements)**\_ \_**
...
<AccordionGroup>
  ...
  <Accordion title="How do I upgrade to the latest version of Blockscout with Autoscout?">
    Updating is easy! Simply **stop** and then **restart** your instance and it is automatically updated to the latest version.
  </Accordion>
</AccordionGroup>
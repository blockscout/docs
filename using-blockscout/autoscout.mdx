...
<Check>
Want to try Autoscout for Free? Request test credits in the [Blockscout Discord](https://discord.gg/blockscout) `#autoscout` channel or email us at community@blockscout.com and we'll top up your account.
</Check>
...
<AccordionGroup>
  ...
  <Accordion title="How do I add a domain / subdomain on Cloudflare using CNAME?">
    ...
    ![Cloudflare Jp](/images/cloudflare.jpg)

    Make sure to set your Custom domain in the Autoscout interface.

    ![My Custom Domain Jp](/images/my-custom-domain.jpg)
  </Accordion>
